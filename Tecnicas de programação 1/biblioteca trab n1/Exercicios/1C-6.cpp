...
/*
6. Construa uma função chamada to_upper_case que receba uma string (pode ser um vetor de char
ou um objeto std::string). A função deverá retornar uma outra string cujo conteúdo seja o
mesmo da string original, mas com todas as letras maiúsculas. Considere que haverão apenas
