...
//1******************************************************************************
void MinhaLib::func1(int a, int b, char m)
{
    for (int i=0;i<a;i++)
    {
        cout<<m;
...
//2******************************************************************************
double MinhaLib::func2(double x)
{
    x=x*x*3.14;
    return x;
}
...
//3******************************************************************************
double MinhaLib::func3(double x)
{
    x=4*3.14/3*x*x*x;
    return x;
}
...
//4******************************************************************************
long long int MinhaLib::func4(int x)
{
    long long int i,a=1;
...
//8******************************************************************************
long long int MinhaLib::func8(int n1, int p1)
{
    long long int c;
...
//12****************************************************************************
void MinhaLib::func12(int n1, char c1)   //1C-7 INCOMPLETA
{

}

//13******************************************************************************
void MinhaLib::func13(int *a, int *b, int *c)
{
    int g;
    int* j=&g;
...
//15******************************************************************************
int MinhaLib::func15(char *a, char *b)
{
    int i=0;
...
//16******************************************************************************
void MinhaLib::func16(long long int *inteiro, char *a)
{
    *inteiro=a[0]-48;
...
//18******************************************************************************
string *MinhaLib::func18(char *s, char a, int *b)
{
    int i=0;
    int cont=0;
    for (; s[i]!='\0'; i++)
...
//19******************************************************************************
int MinhaLib::func19(string a, string b)
{
    int i=0,j=0;
...
//20******************************************************************************
char *MinhaLib::func20(char *a, char *b)
{
    int i=0,j=0,k,l;
...
void MinhaLib::prin(int x)
{
    ...
    if (x==12)
    {
        cout<<"Nao foi feita, desculpa prof :(";
    }
    if (x==13)
    {
        int a,b,c;
        cout<<"Primeiro parametro: ";
        cin>>a;
        cout<<"Segundo parametro: ";
        cin>>b;
        cout<<"Terceiro parametro: ";
        cin>>c;
        func13(&a,&b,&c);
        cout<<a<<endl;
        cout<<b<<endl;
    ...
    if (x==20)
    {
        ...
        cout<<"String 2: ";
        cin>>b;
        char* resultado=func20(a,b);
        cout<<"String R: "<<resultado;
    }
}
